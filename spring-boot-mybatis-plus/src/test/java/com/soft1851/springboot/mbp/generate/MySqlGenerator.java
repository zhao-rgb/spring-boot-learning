...
//                .setInclude("operate_log", "clazz", "teacher", "student", "course", "course_student")
        ...
        dataSourceConfig.setDbType(DbType.MYSQL)
                ...
                .setUrl("jdbc:mysql://rm-m5ee476bu350735gjeo.mysql.rds.aliyuncs.com:3306/db_zxl?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai")
                .setUsername("root")
                .setPassword("XuNiit_#");
